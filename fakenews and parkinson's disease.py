# -*- coding: utf-8 -*-
"""Герауф Никита Александрович 10. Практическая работа

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1kSe74avuOnG3y_2cokxihjCAI_KpUEbz
...
"""7) Вывод: Разработанная модель демонстрирует высокую эффективность в обнаружении болезни Паркинсона. Визуализации помогут лучше понять результаты модели и сделать обоснованные выводы о ее работе."""